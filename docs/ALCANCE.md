...
4. ~~Panel administrador SaaS (cobro de suscripciones real)~~ — implementado en la iteración 12.
   Queda: envío real de recordatorios (proveedor de email/WhatsApp), UI web del panel.
