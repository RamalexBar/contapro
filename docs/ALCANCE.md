...
42. **App móvil completa** — hoy solo POS + dashboard (`apps/mobile`); falta el resto de pantallas
    con cache/offline propio (caja, inventario).
...
44. **IA (categorización automática, asistente conversacional, insights)** — gancho de marketing
